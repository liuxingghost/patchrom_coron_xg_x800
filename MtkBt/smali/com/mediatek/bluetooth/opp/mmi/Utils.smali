...
.method public static createContextFileForText(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/net/Uri;
    ...
    .line 173
    sget-object v14, Landroid/util/Patterns;->WEB_URL:Ljava/util/regex/Pattern;
    ...
    .line 175
    .local v13, urlLink:Ljava/lang/String;
    const/4 v4, 0x0
    ...
    .end local v13           #urlLink:Ljava/lang/String;
    :catch_0
    move-exception v6
    ...
    invoke-static {v14}, Lcom/mediatek/bluetooth/util/BtLog;->e(Ljava/lang/String;)V
    :try_end_1
    ...
    .restart local v13       #urlLink:Ljava/lang/String;
    :cond_5
    if-nez p1, :cond_b
    ...
    invoke-virtual {v0, v9, v14}, Landroid/content/Context;->openFileOutput(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    ...
    invoke-virtual {v11, v2, v14, v15}, Ljava/io/FileOutputStream;->write([BII)V
    ...
    .line 274
    const-string v14, "createContextFile:: filePath start with /data/user/"

    invoke-static {v14}, Lcom/mediatek/bluetooth/util/BtLog;->d(Ljava/lang/String;)V
    ...
    const-string v15, "after convert, new filePath = "
    ...
    const-string v15, "createContextFile::filePath = "
    ...
    invoke-static {v15}, Lcom/mediatek/bluetooth/util/BtLog;->w(Ljava/lang/String;)V
